...
// extern std::vector<int> vals;
extern std::vector<std::vector<std::vector<long> > > comm_steps;
// extern long total_calls;
extern long fid;
...
/***************************Profiling Methods****************************/
/*---------Bcast-----------*/
void profile_Bcast_intra_binomial(int root, int type_size, int count, std::vector<std::vector<long>> &temp_steps, long &calls);
// void profile_Bcast_intra_binomial(int root, int type_size, int count);
void profile_Scatter_for_bcast(int root, int nbytes, std::vector<std::vector<long>> &temp_steps, long &calls);
// void profile_Scatter_for_bcast(int root, int nbytes);
void profile_Bcast_intra_scatter_recursive_doubling_allgather(int root, int type_size, int count, std::vector<std::vector<long>> &temp_steps, long &calls);
// void profile_Bcast_intra_scatter_recursive_doubling_allgather(int root, int type_size, int count);
void profile_Bcast_intra_scatter_ring_allgather(int root, int type_size, int count, std::vector<std::vector<long>> &temp_steps, long &calls);
// void profile_Bcast_intra_scatter_ring_allgather(int root, int type_size, int count);

/*---------Allgather-----------*/
void profile_Allgather_intra_recursive_doubling(int &recvcount, int &type_size, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Allgather_intra_brucks(int &recvcount, int &type_size, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Allgather_intra_ring(int &recvcount, int &type_size, std::vector<std::vector<long>> &temp_steps, long &calls);
...
/*------------Allreduce------------*/
void profile_Allreduce_intra_recursive_doubling(int count, int type_size, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Allreduce_intra_reduce_scatter_allgather(int count, int type_size, std::vector<std::vector<long>> &temp_steps, long &calls);
...
/***************Scatter*****************/
void profile_Scatter_binomial(int root, int sendtype_size, int sendcount, int recvtype_size, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);

// void profile_Scatter_binomial(int root, int sendtype_size, int sendcount, int recvtype_size, int recvcount);

/***************Gather*****************/
void profile_Gather_binomial(int root, MPI_Datatype sendtype, int sendcount, MPI_Datatype recvtype, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);

// void profile_Gather_binomial(int root, MPI_Datatype sendtype, int sendcount, MPI_Datatype recvtype, int recvcount);

/***************Reduce*****************/
void profile_Reduce_intra_reduce_scatter_gather(MPI_Datatype datatype, int root, int count, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Reduce_intra_binomial(MPI_Datatype datatype, int root, int count, MPI_Op op, std::vector<std::vector<long>> &temp_steps, long &calls);
...
/***************Alltoall****************/
void profile_Alltoall_intra_pairwise_sendrecv_replace(MPI_Datatype sendtype, MPI_Datatype recvtype, int sendcount, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Alltoall_intra_brucks(MPI_Datatype sendtype, MPI_Datatype recvtype, int sendcount, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Alltoall_intra_scattered(MPI_Datatype sendtype, MPI_Datatype recvtype, int sendcount, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);
void profile_Alltoall_intra_pairwise(MPI_Datatype sendtype, MPI_Datatype recvtype, int sendcount, int recvcount, std::vector<std::vector<long>> &temp_steps, long &calls);
